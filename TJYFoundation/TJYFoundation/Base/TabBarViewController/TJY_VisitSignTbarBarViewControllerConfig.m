//
//  TJY_VisitSignTbarBarViewControllerConfig.m
//  TJYFoundation
//
...
@interface  TJY_VisitSignTbarBarViewControllerConfig ()<UITabBarControllerDelegate>
@property (nonatomic,strong)CYLTabBarController  * tabBarController;
@end
@implementation TJY_VisitSignTbarBarViewControllerConfig
...
-(NSArray *)viewControllers{
    ...
    TJY_VisitSignHomeViewController *  vc = [sb  instantiateViewControllerWithIdentifier:@"TJY_VisitSignHomeViewController"];
    TJY_TrackViewController  * svc =[sb  instantiateViewControllerWithIdentifier:@"TJY_TrackViewController"];
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : @"拜访签到",
                                                 CYLTabBarItemImage : @"unqiandao",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"qiandao", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"足迹",
                                                  CYLTabBarItemImage : @"unzuji",
                                                  CYLTabBarItemSelectedImage : @"zuji",
                                                  };
