//
//  TJY_SignTabBarViewControllerConfig.m
//  TJYFoundation
//
...
@interface  TJY_SignTabBarViewControllerConfig()<UITabBarControllerDelegate>
@property (nonatomic,strong)CYLTabBarController  * tabBarController;
@end
@implementation TJY_SignTabBarViewControllerConfig
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"undaka",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"daka", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"统计",
                                                  CYLTabBarItemImage : @"unstatistics",
                                                  CYLTabBarItemSelectedImage : @"statistics",
                                                  };
