...
#import "TJY_WebViewController.h"
#import "TJY_JSHandle.h"
@interface TJY_WebViewController ()<WKNavigationDelegate>
@property(nonatomic,strong)TJY_JSHandle  * jsHandle;
@property (nonatomic,assign) double lastProgress;//上次进度条位置
@end

@implementation TJY_WebViewController
...
-(void)initWKWebView
{
    ...
    _jsHandle = [[TJY_JSHandle alloc]initWithViewController:self configuration:configuration];
